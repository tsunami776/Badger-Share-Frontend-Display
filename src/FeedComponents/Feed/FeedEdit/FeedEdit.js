...
import { required, length } from "../../../FeedUtil/validators";
import { generateBase64FromImage } from "../../../FeedUtil/image";
    ...
    return this.props.editing ? (
      <Fragment>
        ...
        <Modal
          ...
          onCancel={this.cancelPostChangeHandler}
          onSubmit={this.acceptPostChangeHandler}
          // isLoading={this.props.loading}
          footer={
            <React.Fragment>
              <NavLink to="/feed">
                <Button inverse onClick={this.cancelPostChangeHandler}>
                  CANCEL
                </Button>
              </NavLink>
              <NavLink to="/feed">
                <Button danger onClick={this.acceptPostChangeHandler}>
                  ACCEPT
                </Button>
              </NavLink>
            </React.Fragment>
